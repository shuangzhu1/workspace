...
class Client
{
    ...
    public static function init($appKey, $masterSecret, $logFile = Config::DEFAULT_LOG_FILE, $retryTimes = Config::DEFAULT_MAX_RETRY_TIMES)
    {
        if (!self::$instance) {
            self::$instance = new self($appKey, $masterSecret, $logFile = Config::DEFAULT_LOG_FILE, $retryTimes = Config::DEFAULT_MAX_RETRY_TIMES);
        }

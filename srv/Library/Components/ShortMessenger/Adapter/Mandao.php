 ...
 * Class Sms 短信发送类
 */
class Mandao extends AbstractAdapter
{
    ...
    /*public function __construct() {
        ...
        $config = $this->di->get('config')->customer_config->$host_key->messenger->mandao;
    ...
    public function send($phone, $message)
    {
        ...
        $argv = array(
            ...
            'pwd' => strtoupper(md5($this->user_name . $this->pass_word)), //密码
            'mobile' => $phone, // 手机号 多个用英文的逗号隔开 post理论没有长度限制.推荐群发一次小于等于10000个手机号
            'content' => (iconv("UTF-8", "gb2312//IGNORE", $message . "[{$this->sign}]")), // 短信内容
            'ext' => '',

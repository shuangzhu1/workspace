...
use Components\Payments\WxPay\WxPayV3\WxPayData\WxPayReport;
...
class WxPayApi
{
	 ...
	 * @param \Components\Payments\WxPay\WxPayV3\WxPayData\WxPayUnifiedOrder $inputObj
	 * @param int $timeOut
	...
	public static function unifiedOrder($inputObj, $timeOut = 30)
	{
		...
		$inputObj->SetAppid(WxPayConfig::init()->getConfigVal(WxPayConfig::APPID));//公众账号ID
		$inputObj->SetMch_id(WxPayConfig::init()->getConfigVal(WxPayConfig::MCHID));//商户号

...
class SignUtil {
	...
	public static $unSignKeyListForPc = array (
		"merchantSign",
		"version" ,
		"successCallbackUrl",
		"forPayLayerUrl"
	);
	public static $unSignKeyListForMb = array (
		"merchantSign",
		"token",
		"version" ,
	);
	public static function signWithoutToHex($params) {
		ksort($params);
		$sourceSignString = self::signString ( $params, SignUtil::$unSignKeyListForPc );
	...
	public static function sign($params) {
		ksort($params);
  		$sourceSignString = self::signString ( $params, self::$unSignKeyListForMb );

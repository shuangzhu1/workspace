 ...
 * under the License.
 */
use Green\Core\Auth\Credential;
use Green\Core\Auth\ShaHmac1Signer;
use Green\Core\Regions\Endpoint;
use Green\Core\Regions\EndpointProvider;
use Green\Core\Regions\ProductDomain;

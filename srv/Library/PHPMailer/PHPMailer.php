...
use Library\PHPMailer\Extras\Html2Text;
...
class PHPMailer
{
    ...
    {
        $configs = include ROOT . '/Config/mail.php';
        if (is_array($config)) {
            $configs = array_merge($configs, $config);
        }
        switch (strtolower($configs['protocol'])) {
            case 'mail': {
                $this->isMail();
                break;
            }
            case 'sendmail' : {
                $this->isSendmail();
                $this->Sendmail = $configs['mailpath'];
                break;
            }
            case 'smtp': {
                $this->isSMTP();
                ...
                $this->Username = $configs['smtp_user'];
                $this->Password = $configs['smtp_pass'];

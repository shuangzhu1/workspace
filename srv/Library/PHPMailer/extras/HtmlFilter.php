<?php
namespace Library\PHPMailer\Extras;
/**
 * htmlfilter.inc
 * ---------------
...
class HtmlFilter
{
     ...
     */
    static function tln_tagprint($tagname, $attary, $tagtype)
    {
        $me = 'tln_tagprint';
        if ($tagtype == 2) {
            $fulltag = '</' . $tagname . '>';
     ...
     */
    static function tln_casenormalize(&$val)
    {
        $val = strtolower($val);
    }
     ...
     */
    static function tln_skipspace($body, $offset)
    {
        $me = 'tln_skipspace';
     ...
     */
    static function tln_findnxstr($body, $offset, $needle)
    {
        $me = 'tln_findnxstr';
     ...
     */
    static function tln_findnxreg($body, $offset, $reg)
    {
        $me = 'tln_findnxreg';
        $matches = Array();
        $retarr = Array();
     ...
     */
    static function tln_getnxtag($body, $offset)
    {
        $me = 'tln_getnxtag';
     ...
     */
    static function tln_deent(&$attvalue, $regex, $hex = false)
    {
        $me = 'tln_deent';
        $ret_match = false;
     ...
     */
    static function tln_defang(&$attvalue)
    {
        $me = 'tln_defang';
        /**
     ...
     */
    static function tln_unspace(&$attvalue)
    {
        $me = 'tln_unspace';
        if (strcspn($attvalue, "\t\r\n\0 ") != strlen($attvalue)) {
     ...
     */
    static function tln_fixatts($tagname,
                                $attary,
                                $rm_attnames,
                                $bad_attvals,
                                $add_attr_to_tag
     ...
     */
    static function tln_sanitize($body,
                                 $tag_list,
...
//
    ...
    static function FilterHTML($body, $trans_image_path, $block_external_images = false)
    {

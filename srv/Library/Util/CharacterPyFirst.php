 ...
 * 汉字拼音首字母工具类
 *  注： 英文的字串：全部大写返回    eg .abc123 => ABC123
 *      中文字符串：返回拼音首字符        eg. 轻风来客 => QFLK
 *      中英混合串: 返回拼音首字符和英文   eg. 我i我j => WIWJ
 *  eg.
 *  $py = CharacterPyFirst::instance()->getInitials("轻风来客");
 *
 */
class CharacterPyFirst
{
    ...
    public static function instance($charset = 'utf-8')
    {

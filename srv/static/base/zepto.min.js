...
// zepto gesture.js
!function(a){function d(a){return"tagName"in a?a:a.parentNode}if(a.os.ios){var c,b={};a(document).bind("gesturestart",function(a){var e=Date.now();e-(b.last||e),b.target=d(a.target),c&&clearTimeout(c),b.e1=a.scale,b.last=e}).bind("gesturechange",function(a){b.e2=a.scale}).bind("gestureend",function(){b.e2>0?(0!=Math.abs(b.e1-b.e2)&&a(b.target).trigger("pinch")&&a(b.target).trigger("pinch"+(b.e1-b.e2>0?"In":"Out")),b.e1=b.e2=b.last=0):"last"in b&&(b={})}),["pinch","pinchIn","pinchOut"].forEach(function(b){a.fn[b]=function(a){return this.bind(b,a)}})}}(Zepto);
// zepto stack.js
 ...
 */
var JSON = JSON || {};
JSON.stringify=JSON.stringify||function(a){var b=typeof a;if("object"!=b||null===a)return"string"==b&&(a='"'+a+'"'),String(a);var c,d,e=[],f=a&&a.constructor==Array;for(c in a)d=a[c],b=typeof d,"string"==b?d='"'+d+'"':"object"==b&&null!==d&&(d=JSON.stringify(d)),e.push((f?"":'"'+c+'":')+String(d));return(f?"[":"{")+String(e)+(f?"]":"}")};
JSON.parse=JSON.parse||function(str){return""===str&&(str='""'),eval("var p="+str+";"),p};
/**
 * base64 Usage

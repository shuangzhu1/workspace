...
//        'img':  'http://bleapi.estt.com.cn/api/user/updateAvatar',
    ...
    require('/static/panel/js/tools/plupload/plupload.min'); //导入图片上传插件
    ...
    exports.uploadAvatar = function (elem, opt, func, func2) {
        var unique = '';
                ...
                FilesAdded: function (up, files) {
                    ...
                    plupload.each(files, function (file) {
                        previewImage(file, function (imgsrc) {
                            ...
                            $("#avatar").attr('src', imgsrc).attr('data-width', width).attr('data-height', height);
                            $("#upload_btn").hide();
                        })
                    });
                },

...
ace.general_things = function (a) {
    a('.ace-nav [class*="fa-animated-"]').closest("a").on("click", function () {
        var d = a(this).find('[class*="fa-animated-"]').eq(0);
    ...
    a("#skin-colorpicker").on("change", function () {
        ...
        if (d == "skin-2") {
            ...
            a(".ace-nav > li:not(:last-child)").addClass("light-pink").find('> a > [class*="fa-"]').addClass("pink").end().eq(0).find(".badge").addClass("badge-warning")
        } else {
            a(".ace-nav > li").removeClass("no-border margin-1");
            a(".ace-nav > li:not(:last-child)").removeClass("light-pink").find('> a > [class*="fa-"]').removeClass("pink").end().eq(0).find(".badge").removeClass("badge-warning")
        }
        if (d == "skin-3") {
...
ace.widget_boxes = function (a) {
    a(document).on("hide.bs.collapse show.bs.collapse", function (c) {
        ...
        a('[href*="#' + b + '"]').find('[class*="fa-"]').each(function () {
            var e = a(this);
            var d;
            var f = null;
            var g = null;
        ...
        if (p == "collapse") {
            ...
            if (p == "close") {
                ...
                if (p == "reload") {
                    ...
                    b.append('<div class="widget-box-overlay"><i class="fa fa-spinner fa-spin fa-2x white"></i></div>');

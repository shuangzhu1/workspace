...
if (!("vars" in window.ace)) {
    window.ace.vars = {icon: " ace-icon ", ".fa": ".fa"}
}
...
ace.settings = {
    is: function (b, a) {
        ...
        if (window.jQuery) {
            jQuery(document).trigger("settings.ace", ["navbar_fixed", a])
        }
        ...
        if (window.jQuery) {
            jQuery(document).trigger("settings.ace", ["sidebar_fixed", a])
        }
        ...
        if (window.jQuery) {
            jQuery(document).trigger("settings.ace", ["breadcrumbs_fixed", a])
        }
        ...
        if (window.jQuery) {
            jQuery(document).trigger("settings.ace", ["main_container_fixed", a])
        }
        ...
        var d = g ? g.querySelector(ace.vars[".fa"]) : null, c, b;
        if (d) {
        ...
        if (window.jQuery) {
            jQuery(document).trigger("settings.ace", ["sidebar_collapsed", a])
        }
    }
};

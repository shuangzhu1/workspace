...
//        'img':  'http://bleapi.estt.com.cn/api/user/updateAvatar',
    ...
    require('tools/plupload/plupload.full.min'); //导入图片上传插件
    ...
    exports.uploadImg = function (elem, opt, func, func2) {
        var unique = '';
                ...
                FilesAdded: function (up, files) {
                    ...
                    plupload.each(files, function (file) {
                        previewImage(file, function (imgsrc) {
                            ...
                            $("#thumb_" + unique).attr('src', imgsrc).attr('data-width', width).attr('data-height', height).show();
                        })

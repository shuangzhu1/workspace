    ...
    i(u, [], function () {
        ...
        function p() {
            ...
            var v = this, y = {
                ...
                responseText: null,
                response: null
            }, w = !0, E, _, x = {}, R, b, T = null, S = null, A = !1, O = !1, I = !1, D = !1, N = !1, L = !1, M, C, F = null, H = null, P = {}, k, U = "", B;
            e.extend(this, y, {
...
;(function (window, o, undef) {
    ...
    plupload.addFileFilter('max_file_size', function (maxSize, file, cb) {
        var undef;
        maxSizeByte = plupload.parseSize(maxSize);
        if (file.size !== undef && maxSize && file.size > maxSizeByte) {
            this.trigger('Error', {
                code: plupload.FILE_SIZE_ERROR,
                message: plupload.translate('File size error.') + '文件不得大于：' + maxSize,
                file: file
            });
            cb(false)
        } else {
    ...
    plupload.addFileFilter('min_file_size', function (minSize, file, cb) {
        var undef;
        minSizeByte = plupload.parseSize(minSize);
        if (file.size !== undef && minSize && file.size < minSizeByte) {
            this.trigger('Error', {
                code: plupload.FILE_SIZE_ERROR,
                message: plupload.translate('File size error.') + '文件不得小于：' + minSize,
                file: file
            });
            cb(false)
        } else {
    ...
    plupload.Uploader = function (options) {
            ...
            function _setOption(option, value, init) {
                ...
                switch (option) {
                    case'max_file_size':
                        ...
                        break;
                    case'min_file_size':
                        if (option === 'min_file_size') {
                            settings.min_file_size = settings.filters.min_file_size = value
                        }
                        break;
                    case'chunk_size':
        ...
        settings = {
            ...
            filters: {mime_types: [], prevent_duplicates: false, max_file_size: 0, min_file_size: 0},
        ...
        plupload.extend(this, {
            ...
            init: function () {
                ...
                if (!settings.browse_button || !settings.url) {
                    this.trigger('Error', {code: plupload.INIT_ERROR, message: plupload.translate('Init error.')});
                    return
                }

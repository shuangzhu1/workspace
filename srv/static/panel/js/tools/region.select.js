...
PCAStead = "@/市,市辖区,/\\+/族自治州,/\\./族自治县,/\\?/族自治县|/'/族自治/ /自治/\\[/城县,/\\^/县|/~/县,/{/城区,/}/市区,/z/区|/y/区,/x/市|/w/市,/v/旗,/u/省$".split("/");
PCAStore = "山阳安南江州东西平宁河新尔海族城龙市中北!大%克&亚/兴0川1台2和3水4巴5武6昌7岛8拉9斯:林;金<德=湖>县A尼B源C马D临E永F特G阿H兰I长J溪K丰L石M云N都O陵P里Q清R苗S化T口U乌V利W青X定Y吉Z华]古_罗`门a港b白c通d高e沙f国g达h家i乐j彝k泉l子m哈n地o乡p广q隆r原s黄t布";
...
function PCAS() {
    this.SelP = document.getElementById(arguments[0]) || document.getElementsByName(arguments[0])[0];
    this.SelC = document.getElementById(arguments[1]) || document.getElementsByName(arguments[1])[0];
    this.SelA = document.getElementById(arguments[2]) || document.getElementsByName(arguments[2])[0];
